$(document).ready(function() {
    // I GOT ABOUT THIS FAR WITH MY CODE, THE REST IS TEMPLATE MATERIAL i will work on finishing this assingment today/this weekend
    var headlineContainer = $(".headline-container");
    ...
    function renderArticles(articles) {
      ...
      for (var i = 0; i < articles.length; i++) {
        headlinePanels.push(createPanel(articles[i]));
      }
      // Once we have all of the HTML for the articles stored in our articlePanels array,
      // append them to the articlePanels container
      headlineContainer.append(headlinePanels);
    }
    ...
    function renderEmpty() {
      ...
      headlineContainer.append(emptyAlert);
    }
